...
{
   # This function is used to get large DM regions that is either hyper or hypo methylated from a whole chromosome. 
   ...
   # ---------------------------------------------------------------------------
   # Note 1: "chr.DM.status.matrix", usually it is a result from HMM.DM. It has the following 12 columns: 
   ...
   # ---------------------------------------------------------------------------
   # Note 4: "distance.threshold", a numeric shows the threshold of physical distance. The CG sites with distance larger than this value won't be in the same region.
